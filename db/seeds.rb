...
prod1 = Product.create(product_type: "Yeezy Shirt - 50", price: 50)
prod2 = Product.create(product_type: "Yeezy Pants - 50", price: 50)
prod3 = Product.create(product_type: "Yeezy Pop - free.99", price: 1)
